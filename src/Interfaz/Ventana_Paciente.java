...
public class Ventana_Paciente extends javax.swing.JFrame
{
    ...
    Connection con;
    ArrayList<Object> columnaMap = new ArrayList();
    ...
    private void initComponents()
    {
        ...
        jPanelHistorial.add(jTFNomCompPac, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 270, 20));
    ...
    {//GEN-HEADEREND:event_jBConsultarActionPerformed
        try
        {
            ...
            Querys q = new Querys();
            columnaMap = q.Seleccion(con, "*", "datos_paciente", "folio_asignado = '" + jTFCurp.getText().toUpperCase().substring(0, 10) + "'");
            if (jTFCurp.getText().length() < 18)
            {
                Mensaje.error(this, "CURP menor a 18");
                CtrlInterfaz.selecciona(jTFCurp);
            } else
            {
                if (columnaMap.get(0).equals(" "))
                {
                    //obtencion de folio por medio del curp
        ...
        {
            System.out.println("Error, el dato es menor al rango de 10 " + e);
            Mensaje.error(this, "CURP menor a 18");
            CtrlInterfaz.selecciona(jTFCurp);
        }
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        ...
        CtrlInterfaz.limpia(jTFNombre, jTFAPaterno, jTFAMaterno, jTFCurp, jTFNomCompPac, jTFFolio, jTFCurp2, jTFFecNac, jTFTelefono,
                ...
                jTFMunicipio, jTFColonia, jTFCalle, jTFNumero,
                jTFReligion, jTFTrabajo,
                jTextFieldNomComDoc1, jTextFieldCedulaProfesional, jTextFieldDireccionDoc, jTextFieldEdadDoc, jTextFieldSexoDoc, jTextFieldTelefonoDoc);
    ...
    {//GEN-HEADEREND:event_jBGuardarActionPerformed
        String valores = ("'" + jTFFolio.getText()) + "',";
        valores += ("'" + jTFNombre.getText() + "',");
        valores += ("'" + jTFAPaterno.getText() + "',");
        valores += ("'" + jTFAMaterno.getText() + "',");
        valores += ("'" + jTFCurp2.getText() + "',");
        valores += ("'" + jTFFecNac.getText() + "',");
        valores += ("'" + (((String) jCBSexo.getSelectedItem())) + "',");
        valores += ("'" + (((String) jCBTipoSangre.getSelectedItem())) + "',");
        valores += ("'" + jTFReligion.getText() + "',");
        valores += ("'" + jTFTelefono.getText() + "',");
        valores += ("'" + jTFTrabajo.getText() + "',");
        valores += ("'" + jTFCalle.getText() + "',");
        valores += (jTFNumero.getText() + ",");
        valores += ("'" + jTFColonia.getText() + "',");
        valores += ("'" + jTFMunicipio.getText() + "'");

        Querys q = new Querys();
        String s = q.Insertar(con, "datos_paciente", valores);
        if (s != null)
        {
            Mensaje.error(this, s);
        } else
        {
    ...
    public boolean activa(boolean flag)
    {
        ...
        if (flag)
        {
            ...
            jTFFolio.setText(columnaMap.get(0).toString());
            jTFNombre.setText(columnaMap.get(1).toString());
            jTFAPaterno.setText(columnaMap.get(2).toString());
            jTFAMaterno.setText(columnaMap.get(3).toString());
            jTFCurp.setText(columnaMap.get(4).toString());
            jTFCurp2.setText(columnaMap.get(4).toString());
            jTFFecNac.setText(columnaMap.get(5).toString());

            for (int i = 0; i < 2; i++)
            {
                if (columnaMap.get(6).toString().substring(1).equals(jCBSexo.getItemAt(i)))
                {
            ...
            for (int i = 0; i < 8; i++)
            {
                if (columnaMap.get(7).toString().substring(1).equals(jCBTipoSangre.getItemAt(i)))
                {
            ...
            jTFReligion.setText(columnaMap.get(8).toString());
            jTFTelefono.setText(columnaMap.get(9).toString());
            jTFTrabajo.setText(columnaMap.get(10).toString());
            jTFCalle.setText(columnaMap.get(11).toString());
            jTFNumero.setText(columnaMap.get(12).toString());
            jTFColonia.setText(columnaMap.get(13).toString());
            jTFMunicipio.setText(columnaMap.get(14).toString());

            CtrlInterfaz.habilita(false, jTFNomCompPac, jTFFolio, jTFCurp2, jTFFecNac, jTFTelefono,
                    jTFFolio, jTFFecNac, jTFTelefono,
                    jTFMunicipio, jTFColonia, jTFCalle, jTFNumero,
                    jTFReligion, jTFTrabajo, jBGuardar, jBConsultar,
                    jTFNombre, jTFAMaterno, jTFAPaterno, jTFCurp);
        ...
        } else if (flag == false)
        {
            ...
            CtrlInterfaz.habilita(true, jTFFecNac, jTextAreaAntPer, jTextAreaAntFam, jTextAreaAntPat, jTextAreaAntQuir, jScrollPane2);
            CtrlInterfaz.habilita(false, jTFNomCompPac, jTFCurp2, jTFTelefono, jTFTelefono,
                    jTFMunicipio, jTFColonia, jTFCalle, jTFNumero,
                    jTFReligion, jTFTrabajo, jTFNombre,
                    jTFAPaterno, jTFAMaterno, jTFCurp, jBConsultar
            );
